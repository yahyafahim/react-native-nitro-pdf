///
/// HybridNitroPdfManager.kt
/// This file was generated by nitrogen. DO NOT MODIFY THIS FILE.
/// https://github.com/mrousavy/nitro
/// Copyright © Marc Rousavy @ Margelo
///

package com.margelo.nitro.nitropdf.views
...
/**
 * Represents the React Native `ViewManager` for the "NitroPdf" Nitro HybridView.
 */
public class HybridNitroPdfManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridNitroPdf::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridNitroPdf(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroPdfStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridNitroPdf? {
    return view.getTag(associated_hybrid_view_tag) as? HybridNitroPdf
  }
}
