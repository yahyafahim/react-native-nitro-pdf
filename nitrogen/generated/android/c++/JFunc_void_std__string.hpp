...
namespace margelo::nitro::nitropdf {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitropdf/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitropdf/Func_void_std__string_cxx;";
